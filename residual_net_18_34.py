...
@ReadMe: script generate_residual_net.py and residual_net_18_34.py are utilized to create residual net 
         18/34 layer.
...
def redisual_connect_no_dimen_match( bottom, base_output = 64 ):
    ...
    res_i_conv1, res_i_conv1_bn, res_i_conv1_scale, res_i_conv1_relu = \
        block_conv_bn_scale_relu( res_i_relu, num_output = base_output, kernel_size = 3, stride = 1, pad = 1 )
    res_i_conv2 = \
        conv( res_i_conv1_relu, num_output = base_output, kernel_size = 3, stride = 1, pad = 1 )

    eletwise_layer = eletwise( bottom, res_i_conv2 )
    
    return res_i_bn, res_i_scale, res_i_relu, res_i_conv1, res_i_conv1_bn, res_i_conv1_scale, res_i_conv1_relu, res_i_conv2, eletwise_layer


def redisual_connect_with_dimen_match( bottom, stride = 1, base_output = 64 ):
    res_i_bn, res_i_scale, res_i_relu = bn_scale_relu( bottom )
    res_i_conv1, res_i_conv1_bn, res_i_conv1_scale, res_i_conv1_relu = block_conv_bn_scale_relu( res_i_relu, num_output = base_output, kernel_size = 3, stride = stride + 1, pad = 1 )
    res_i_conv2 = conv( res_i_conv1_relu, num_output = base_output, kernel_size = 3, stride = 1, pad = 1 )

    #in the dimension match layer, the stride should be 2
    res_i_match_conv, res_i_match_bn, res_i_match_scale = block_conv_bn_scale( bottom, num_output = base_output, kernel_size = 1, stride = 2, pad = 0 )

    eletwise_layer = eletwise( res_i_match_scale, res_i_conv2 )
    return res_i_bn, res_i_scale, res_i_relu, res_i_conv1, res_i_conv1_bn, res_i_conv1_scale, res_i_conv1_relu, res_i_conv2, res_i_match_conv, res_i_match_bn, res_i_match_scale, eletwise_layer


def redisual_connect_with_dimen_match_no_patch_reduce( bottom, stride = 1, base_output = 64 ):
    res_i_bn, res_i_scale, res_i_relu = bn_scale_relu( bottom )
    res_i_conv1, res_i_conv1_bn, res_i_conv1_scale, res_i_conv1_relu = block_conv_bn_scale_relu( res_i_relu, num_output = base_output, kernel_size = 3, stride = stride, pad = 1 )
    res_i_conv2 = conv( res_i_conv1_relu, num_output = base_output, kernel_size = 3, stride = stride, pad = 1 )

    res_i_match_conv, res_i_match_bn, res_i_match_scale = block_conv_bn_scale( bottom, num_output = base_output, kernel_size = 1, stride = 1, pad = 0 )
...
n.res(stage)_conv2, n.res(stage)_eletwise = \
...
n.res(stage)_conv1, n.res(stage)_conv1_bn, n.res(stage)_conv1_scale, n.res(stage)_conv1_relu,\
n.res(stage)_conv2, n.res(stage)_match_conv, n.res(stage)_match_bn, n.res(stage)_match_scale, n.res(stage)_eletwise = \
...
class ResNet(object):
    ...
    def resnet_layers_proto( self, batch_size, phase = 'TRAIN', stages = (2, 2, 2, 2) ):
        n = caffe.NetSpec()
        if phase == 'TRAIN':
        ...
        n.conv1, n.conv1_bn, n.conv1_scale, n.conv1_relu = \
            block_conv_bn_scale_relu( n.data, num_output = 64, kernel_size = 7, stride = 2, pad = 3 )
